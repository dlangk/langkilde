...
I write a lot about building companies. At one point [in the past](https://langkilde.se/post/2021-10-25-risk-and-reward-in-technology), I wrote: "If you care about raising a huge round from a top-tier VC, then you need to make very deliberate choices." I want to dig deeper into what I’ve learned about what such deliberate choices might look like. My usual caveat is that my thoughts are only about building extremely valuable companies. There are many other ways to build smaller and less risky companies.
